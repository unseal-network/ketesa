const misc_resources = {
  ...
  checkin_admin: {
    ...
    adjustment: {
      title: "调整积分余额",
      description: "对本服务器上的 Matrix 账号统一增加或扣减积分。整批操作要么全部成功，要么全部不变。",
      user_ids: "Matrix 用户 ID",
      user_ids_helper: "每行输入一个用户 ID，最多 100 个账号。",
      amount: "带正负号的积分调整值",
      amount_helper: "正数增加积分，负数扣减积分。",
      review: "核对调整内容",
      confirm_title: "确认调整积分",
      confirm_body: "将 %{amount} 积分应用到 %{count} 个账号？任何账号的余额都不会低于零。",
      confirm: "应用调整",
      cancel: "取消",
      processing: "正在应用…",
      success: "已对 %{count} 个账号应用 %{amount} 积分。",
      replayed: "此请求已处理，以下显示已保存的结果。",
      failure: "调整积分失败：%{error}",
      validation: {
        users_required: "请至少输入一个 Matrix 用户 ID。",
        too_many_users: "每批最多包含 100 个用户 ID。",
        duplicate_users: "请先移除重复的用户 ID。",
        invalid_amount: "请输入 -1,000,000 到 1,000,000 之间的非零整数。",
      },
      result: {
        user: "账号",
        previous: "调整前余额",
  ...
  password_help_requests: {
    name: "密码协助申请",
    description: "申请只标识需要协助的账号，不代表已验证申请人身份。请先通过现有客服渠道核验，再更新密码。",
    pending_count: "%{smart_count} 条待处理密码协助申请",
    status: {
      pending: "待处理",
      resolved: "已处理",
      dismissed: "已忽略",
    ...
    fields: {
      user_id: "用户",
      first_requested_at: "首次申请时间",
      last_requested_at: "最近申请时间",
      request_count: "申请次数",
      status: "状态",
      actions: "操作",
    },
    action: {
      ...
      resolve: "标记已处理",
      dismiss: "忽略",
      resolve_success: "密码协助申请已标记为已处理。",
      dismiss_success: "密码协助申请已忽略。",
      update_failure: "更新密码协助申请失败。",
    },
    empty: "没有密码协助申请。",
    load_failure: "加载密码协助申请失败。",
  },
  account_data: {
    name: "账户数据",
  },
