  ...
  ketesa: {
    auth: {
      ...
      admin2fa: {
        ...
        description: "Enter your username first. Administrator access requires a password and an authenticator code.",
        continue: "Continue",
        enroll_title: "Set up your authenticator",
        verify_title: "Verify your sign-in",
        scan_hint: "Scan this QR code with an authenticator app, then enter the six digit code.",
        code: "Authenticator code",
        sign_in: "Verify and sign in",
        use_different_account: "Use a different account",
        security_note: "The setup key is shown only during setup and is never saved in this browser.",
        invalid: "We could not verify those details. Check your password and code, then try again.",
      },
      server_state: {
    ...
    security: {
      menu_label: "Account security",
      title: "Account security",
      description: "Manage the authenticator apps that can approve administrator sign-ins.",
      factors: "Authenticator apps",
      none: "No authenticators are configured.",
      add_title: "Add an authenticator",
      add: "Add authenticator",
      name: "Name",
      authenticator_default: "Authenticator app",
      confirm_title: "Confirm new authenticator",
      scan_hint: "Scan the QR code with your authenticator app and enter the current code to activate it.",
      remove_title: "Remove authenticator",
      remove_description: "Enter a current code from another authenticator that will remain active.",
      last_factor_disabled: "At least one authenticator must remain.",
      added: "Authenticator added",
      removed: "Authenticator removed",
      invalid_code: "That code is not valid. Try the current code from your authenticator.",
      request_failed: "The request could not be completed. Try again.",
      load_failed: "Authenticators could not be loaded. Try again.",
    },
  },
  import_users: {
    error: {
