...
const misc_resources = {
  ...
  checkin_admin: {
    ...
    adjustment: {
      title: "Adjust point balances",
      description: "Apply the same signed adjustment to local Matrix accounts. The batch is all-or-nothing.",
      user_ids: "Matrix user IDs",
      user_ids_helper: "Enter one user ID per line, up to 100 accounts.",
      amount: "Signed point adjustment",
      amount_helper: "Use a positive value to add points or a negative value to subtract them.",
      review: "Review adjustment",
      confirm_title: "Confirm point adjustment",
      confirm_body: "Apply %{amount} points to %{count} accounts? No account balance can go below zero.",
      confirm: "Apply adjustment",
      cancel: "Cancel",
      processing: "Applying…",
      success: "Applied %{amount} points to %{count} accounts.",
      replayed: "This request was already applied. The saved result is shown below.",
      failure: "Point adjustment failed: %{error}",
      validation: {
        users_required: "Enter at least one Matrix user ID.",
        too_many_users: "A batch can include at most 100 user IDs.",
        duplicate_users: "Remove duplicate user IDs before continuing.",
        invalid_amount: "Enter a non-zero whole number from -1,000,000 to 1,000,000.",
      },
      result: {
        user: "Account",
