const users = {
  ...
  action: {
    ...
    reset_password: {
      ...
      helper: "Set a new password for %{user}. This will log out all of their existing devices.",
      password: "New password",
      confirm_password: "Confirm new password",
      target: "Confirm target user",
      target_helper: "Type %{user} exactly to confirm this account.",
      show_password: "Show password",
      saving: "Resetting password…",
      ...
      error_target_mismatch: "Type the target user ID exactly to confirm",
    },
    login_as: {
      label: "Login as user",
      title: "Login as user",
