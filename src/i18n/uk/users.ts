const users = {
  ...
  phone_remark: {
    label: "Телефон (примітка)",
    helper: "Вказано користувачем під час реєстрації; не перевірено.",
    not_provided: "Не вказано",
    unavailable: "Недоступно на цьому сервері",
    load_failed: "Не вдалося завантажити номер телефону",
